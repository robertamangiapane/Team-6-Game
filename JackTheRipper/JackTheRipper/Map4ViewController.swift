...
//        self.navigationItem.rightBarButtonItem?.isEnabled = false
    ...
    func crimescene4entered() {
        ...
        let alert = UIAlertController(title: "You arrive at the crimescene", message: "PC Edward Watkins disovered the body of Catherine Eddowes just after 1:30 AM on September 8, 1888.", preferredStyle: .alert)
